        ...
        <div className=' shadow-md rounded-md w-full xl:w-[60%] xl:mx-[20%] min-h-[400px] grid grid-cols-1 md:grid-cols-2 gap-4'>
            <div className='h-full bg-main rounded-tl-md rounded-bl-md'>
                ...
                <div className='my-10 text-white p-4'>
                    ...
                    <p className='text-md md:text-sm my-4'>Join Kenya's Leading Tuition Platform for Teachers! Unlock limitless earning potential while empowering students to excel. Your journey to financial growth and meaningful impact starts here.</p>
                </div>
                {/* testimonial */}
            ...
            <div>
                ...
                <div className='flex flex-col p-4 my-4 w-full md:w-[85%] items-center md:items-start'>
                    <div className='flex flex-col my-2 w-[80%] md:w-full'><label className='text-grey text-md my-2' htmlFor="user_name">full name</label>
                    <input type="text" id='user_name'  className='bg-transparent border border-gray-400 h-[45px] rounded-md'/></div>
                    <div className='flex flex-col my-2 w-[80%] md:w-full'><label className='text-grey text-md my-2' htmlFor="email">email</label>
                    <input type="email" id='email'  className='bg-transparent border border-gray-400 h-[45px] rounded-md'/></div>
                    <div className='flex flex-col my-2 w-[80%] md:w-full'><label className='text-grey text-md my-2' htmlFor="phone">phone( eg +2547***)</label>
                    <input type="text" id='phone'  className='bg-transparent border border-gray-400 h-[45px] rounded-md'/></div>
                    <button className='my-4 bg-main w-[80%] md:w-full h-[45px] rounded-md hover:text-white'>sign in</button>
                    ...
                    <div className='my-10 w-full '>
                        ...
                        <div className='w-full p-2'>
                          <button className='bg-beige w-[80%] mx-[10%] md:mx-0 md:w-full h-[45px] rounded-md hover:text-white my-4  flex items-center justify-center gap-4 '><FaGoogle />signup with google</button>  
                        </div>
